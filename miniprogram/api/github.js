...
const githubSecert = "?client_id=093a7ed958a206f60a37&client_secret=3dc925411cdea302056f7d22a5123efe2dbad079"
...
const trendings = (since, language) => new Promise((resolve, reject) => {
  ...
  http.get(url, { params: { since, language } }).then(({ status, headers, data }) => {
    ...
    const trends = data.map((it, index) => {
